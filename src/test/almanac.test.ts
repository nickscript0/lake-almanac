...
import { Almanac, frToOutdoorReadingDay, updateAlmanac, findNearestReadingToTime } from '../almanac';
...
describe('almanac', () => {
    test('benchmark: updateAlmanac should process 1 day from empty almanac', async () => {
        ...
        // await writeFile('src/test/res/almanac-2021-01-02-to-2021-01-3.json', JSON.stringify(alm, undefined, 2));

        expect(alm).toEqual(expectedAlm);
    });

    test('benchmark: updateAlmanac should process days from all seasons', async () => {
    ...
    test('findNearestReadingToTime works with DST dataset', () => {
